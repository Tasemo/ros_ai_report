...
\newcommand{\thesistitle}{Voice Command Recognition with Convolutional Neural Networks} % Title of the thesis
\newcommand{\submissiondate}{28. March, 2021} % Submission date "Month, year"
